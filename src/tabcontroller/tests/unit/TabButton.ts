...
registerSuite('TabButton', {
	...
	tests: {
		...
		'Escape should close tab'() {
			...
			const h = harness(() => w(TabButton, props(extraProps)));
			h.trigger('@tab-button', 'onkeydown', { which: Keys.Escape, stopPropagation });
