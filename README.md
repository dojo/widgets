...
1. A widgets properties interface must by the name of the widget with a suffix of `Properties`.
...
The examples also run on codesanbox, to run the examples on the master branch go to 
